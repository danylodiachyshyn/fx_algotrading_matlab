% test_my_6D_Sensitivity_DoubleEMA_ATR
clear, clc, close all

% --- Data Loading Setup ---
adress = '/MATLAB Drive/Main/Data/';
FTSname = 'EURUSD_Daily.mat';
data = load([adress, FTSname]);
data = data.data;
data = data(:,1:5); 

FTSname2 = 'EURUSD Daily';
TF = 'Daily';
Currency = '$';
...
[ECAll, optParams, ECOpt] = my_Sensitivity_Double_EMA_ATR_Strategy_SLTP(...
    data, FTSname2, TF, Currency, ...
    periodFastRange, periodSlowRange, periodATRRange, atrThresholdRange, ...
    SLRange, TPRange, plotparam);
